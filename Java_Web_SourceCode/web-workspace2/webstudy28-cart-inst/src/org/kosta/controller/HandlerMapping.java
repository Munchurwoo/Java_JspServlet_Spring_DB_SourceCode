...
public class HandlerMapping {
	...
	public Controller create(String command){
		...
		}else if(command.equals("BoardPostFormController")) {
			controller=new BoardPostFormController();
		}else if (command.equals("BoardPostFormDetailController")) {
			controller=new BoardPostFormDetailController();
		}
		return controller;
	}
}
